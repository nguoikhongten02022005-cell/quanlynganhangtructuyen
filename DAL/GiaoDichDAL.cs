...
/// <summary>
/// Data Access Layer cho bảng GiaoDich
/// </summary>
public class GiaoDichDAL
{
    private readonly NganHangContext _context;

    public GiaoDichDAL(NganHangContext context)
    {
        _context = context;
    }
    ...
    public async Task<int> ThemGiaoDichAsync(int maTaiKhoanGui, int maTaiKhoanNhan, decimal soTien, string? noiDung, string trangThai, string maOTP, DateTime thoiHanOTP)
    {
    ...
    public async Task<(int MaTaiKhoanGui, int MaTaiKhoanNhan, decimal SoTien, string NoiDung, string TrangThai, string MaOTP, DateTime ThoiHanOTP)?> GetGiaoDichByIdAsync(int maGiaoDich)
    {
        await using var conn = await GetOpenConnectionAsync();
    ...
    public async Task<int> CapNhatTrangThaiGiaoDichAsync(int maGiaoDich, string trangThai, DateTime? ngayGiaoDich = null)
    {
        await using var conn = await GetOpenConnectionAsync();
